...
public class Cliente {
    private String nome;
    private String cpf;
    private ArrayList <Endereco> enderecos = new ArrayList<>(2);
    private ArrayList <Contato> contatos = new ArrayList<>(2);
    ...
    public Cliente(String nome, String cpf, ArrayList <Endereco> enderecos, Contato contato) {
        this.nome = nome;
        this.cpf = cpf;
